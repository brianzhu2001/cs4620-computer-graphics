...
export default class AModel2D extends AModel{
    ...
    getObjectToWorldMatrix(){
        return this.matrix;
        // if(this.getParent() && this.getParent().matrix){
    ...
    //The inverse transformation is defined in the super class as below. You should not need to change it,
    //since it uses getObjectToWorldMatrix as a subroutine
    // getWorldToObjectMatrix(){return this.getObjectToWorldMatrix().getInverse();}
